    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - EMUKA moringa Ordering System Design & Developed By <a href="https://twitter.com/_mwathi_MR">Dennis Mwathi +254715949386 </a></div></div>
        </footer>
